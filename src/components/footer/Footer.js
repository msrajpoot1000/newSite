        ...
        <div class="container py-5 px-lg-5">
          <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <div class="row g-2">
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio1} alt="Image" />
                </div>
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio2} alt="Image" />
                </div>
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio3} alt="Image" />
                </div>
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio4} alt="Image" />
                </div>
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio5} alt="Image" />
                </div>
                <div class="col-4">
                  <img class="img-fluid" src={Portfolio5} alt="Image" />
                </div>
          ...
          <div class="copyright">
            <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                ...
                , All Right Reserved. This template is free as long as you keep
                the footer author’s credit link/attribution link/backlink. If
                you'd like to use the template without the footer author’s
                credit link/attribution link/backlink, you can purchase the
