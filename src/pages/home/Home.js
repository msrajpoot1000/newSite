        ...
        <div class="container-xxl py-5">
          <div class="container px-lg-5">
            ...
            <div class="row g-4 portfolio-container">
              ...
              >
                <div class="position-relative rounded overflow-hidden">
                  <img class="img-fluid w-100" src={Portfolio2} alt="" />
                  <div class="portfolio-overlay">
                    <a
                      class="btn btn-light"
              ...
              >
                <div class="position-relative rounded overflow-hidden">
                  <img class="img-fluid w-100" src={Portfolio3} alt="" />
                  <div class="portfolio-overlay">
                    <a
                      class="btn btn-light"
              ...
              >
                <div class="position-relative rounded overflow-hidden">
                  <img class="img-fluid w-100" src={Portfolio4} alt="" />
                  <div class="portfolio-overlay">
                    <a
                      class="btn btn-light"
              ...
              >
                <div class="position-relative rounded overflow-hidden">
                  <img class="img-fluid w-100" src={Portfolio5} alt="" />
                  <div class="portfolio-overlay">
                    <a
                      class="btn btn-light"
              ...
              >
                <div class="position-relative rounded overflow-hidden">
                  <img class="img-fluid w-100" src={Portfolio6} alt="" />
                  <div class="portfolio-overlay">
                    <a
                      class="btn btn-light"
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                  <div class="d-flex">
                    ...
                    <img class="img-fluid rounded w-100" src={Team1} alt="" />
                  </div>
                  <div class="px-4 py-3">
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                  <div class="d-flex">
                    ...
                    <img class="img-fluid rounded w-100" src={Team2} alt="" />
                  </div>
                  <div class="px-4 py-3">
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                <div class="team-item">
                  <div class="d-flex">
                    ...
                    <img class="img-fluid rounded w-100" src={Team3} alt="" />
                  </div>
                  <div class="px-4 py-3">
